...
public class CausalConnector implements IEditorActionDelegate {
	...
	public void setActiveEditor(IAction action, IEditorPart targetEditor) {
		...
		NCLEditor editor = ((NCLMultiPageEditor) targetEditor.getEditorSite().getPage()
				.getActiveEditor()).getNCLEditor();
		doc = NCLSourceDocument.createNCLSourceDocumentFromIDocument(editor.getInputDocument());
	}
