...
public class NCLHoverInformationControl2 extends AbstractInformationControl
	...
	public Point computeSizeHint() {
		...
		if (fisImage && TinyImage) {
			return getShell().computeSize(this.image.getBounds().width,
					this.image.getBounds().height, true);
		}
		if (fisRegion) {
		...
		/*
		 * int widthHint= SWT.DEFAULT; Point constraints= getSizeConstraints();
		 * if (constraints != null) widthHint= constraints.x;
		 */
