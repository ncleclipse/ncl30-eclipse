...
public class GingaVMLaunchConfiguration extends LaunchConfigurationDelegate{
	...
	public void launch(ILaunchConfiguration configuration, String mode,
		...
		// TODO SSH Support
		System.out.println("Ginga VM Launch Configuration "+configuration.getAttribute("host", "192.168.117.1")+" - "+configuration.getAttribute("userName", "root")+" - "+configuration.getAttribute("userPassword", "telemidia"));
	}
