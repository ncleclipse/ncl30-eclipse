 ...
 * "ncl". If a sample multi-page editor (also available
 * as a template) is registered for the same extension, it will
 * be able to open it.
 */

public class NCLNewWizard extends Wizard implements INewWizard {
	protected NCLNewWizardPage page;
	protected ISelection selection;

	/**
	 * Constructor for NCLNewWizard.
	 */
	public NCLNewWizard() {
		super();
	...
	public void addPages() {
		page = new NCLNewWizardPage(selection);
		addPage(page);
	}
	...
	protected void doFinish(String containerName, String fileName,
		...
		try {
			InputStream stream = openContentStream(fileId);
			if (file.exists()) {
