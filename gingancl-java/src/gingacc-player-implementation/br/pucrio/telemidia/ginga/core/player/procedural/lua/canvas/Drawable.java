...
public abstract class Drawable{
	...
	protected Point getRealPosition(){
		if(parentCanvas != null){
			Point parentPosition = parentCanvas.getPosition();
	...
	protected Point getParentCanvasPosition(){
		if(parentCanvas==null)
			...
			return parentCanvas.getPosition();
	}
	
	public Drawable(LuaCanvas parentCanvas, int x, int y){
		this.parentCanvas = parentCanvas;
		this.x=x;
		this.y=y;
	}
	
	public Drawable(LuaCanvas parentCanvas){
		this(parentCanvas,0,0);
	}
	...
	public void setParentCanvas(LuaCanvas canvas){
