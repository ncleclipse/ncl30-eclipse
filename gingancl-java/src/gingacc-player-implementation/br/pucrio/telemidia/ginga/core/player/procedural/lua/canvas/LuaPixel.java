...
public class LuaPixel extends LuaColoredDraw{
	
	public LuaPixel(LuaCanvas parentCanvas, int x, int y, Color color){
		super(parentCanvas,x,y,color);
	}
	
	public LuaPixel(LuaCanvas parentCanvas, int x, int y){
		this(parentCanvas,x,y,Color.BLACK);
	}
	...
	public void draw(Graphics g) {
		...
		g.drawLine(position.x /*+ parentCanvasPosition.x*/,
				position.y /*+ parentCanvasPosition.y*/, 
				position.x /*+ parentCanvasPosition.x*/, 
				position.y /*+ parentCanvasPosition.y*/);
		g.setColor(oldColor);
	}
}
