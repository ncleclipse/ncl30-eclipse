...
public class LuaEllipse extends LuaShape{
	private int arc_begin;
	public LuaEllipse(LuaCanvas parentCanvas, int x, int y, int width, int height, int arc_begin, int arc_end, Color color, boolean filled) {
