...
public class LuaRectangle extends LuaShape{
	...
	public LuaRectangle(LuaCanvas parentCanvas, int x, int y, int width, int height, Color color, boolean filled) {
		super(parentCanvas, x, y, width, height, color, filled);
	}
