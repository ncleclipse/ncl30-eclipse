...
/**
 * This plugin implements ImageJ's Help/ImageJ Web Site command. It is a
 * slightly modified version of Eric Albert's cross-platform (Windows, Mac, Mac
 * OS X and Unix) BrowserLauncher class.
 * <p>
...
public class BrowserLauncher {
	...
	public static void openURL(String url) throws IOException {
		...
		case MRJ_3_0:
			...
			if (result == 0) {
				...
				throw new IOException("Unable to create an Internet Config instance: "
						+ result);
			}
			break;
		case MRJ_3_1:
	...
	private native static int ICLaunchURL(int instance, byte[] hint, byte[] data,
			int len, int[] selectionStart, int[] selectionEnd);
}