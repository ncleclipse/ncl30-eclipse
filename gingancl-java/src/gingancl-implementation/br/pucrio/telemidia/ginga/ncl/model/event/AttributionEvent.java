...
public class AttributionEvent extends FormatterEvent implements
		IAttributionEvent {
	...
	public AttributionEvent(String id, IExecutionObject executionObject,
			IPropertyAnchor anchor) {
		super(id, executionObject);
		this.anchor = anchor;
		this.value = (String) anchor.getPropertyValue();
	...
	public boolean setValue(String newValue) {
		if ((value == null && newValue != null)
				...
				|| (newValue != null && value != null && !newValue.equals(value))) {
			value = newValue;
			return true;
		}
		else {
	...
	public void setValueMaintainer(IAttributeValueMaintainer valueMaintainer) {
