...
public class EndEventTransition extends EventTransition implements
		IEndEventTransition {
	private static final long serialVersionUID = 4026134701540275477L;
	private IBeginEventTransition begin_transition;

	public EndEventTransition(double time, IPresentationEvent event,
			IBeginEventTransition transition) {

		super(time, event);
		begin_transition = transition;
		begin_transition.setEndTransition(this);
	}
