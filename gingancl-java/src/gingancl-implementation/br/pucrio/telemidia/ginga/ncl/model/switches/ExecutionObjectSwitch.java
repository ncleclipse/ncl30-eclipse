...
public class ExecutionObjectSwitch extends CompositeExecutionObject implements
	...
	public ExecutionObjectSwitch(String id, INode switchNode) {
		super(id, switchNode);
		selectedObject = null;
	}
	...
	public void select(IExecutionObject executionObject) {
		Iterator<IFormatterEvent> events;
		ISwitchEvent switchEvent;

		if (executionObject != null
				&& super.containsExecutionObject(executionObject.getId())) {
	...
	public boolean addEvent(IFormatterEvent event) {
		if (event instanceof IPresentationEvent
				&& ((IPresentationEvent)event).getAnchor() instanceof ILambdaAnchor) {
			super.wholeContent = (IPresentationEvent)event;
			return true;
		}
		else {
